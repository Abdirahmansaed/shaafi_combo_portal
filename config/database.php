...
return [
    ...
    */
    ...
    // Keep the writable portal database as Laravel's default. Business data
    // must always opt in through the explicitly named read-only connection.
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_business' => [
            ...
            'database' => env('BUSINESS_DB_DATABASE', 'mydatabase'),
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('BUSINESS_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
        ...
        'mysql_portal' => [
            ...
            'database' => env('PORTAL_DB_DATABASE', 'shaafi_portal'),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('PORTAL_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
